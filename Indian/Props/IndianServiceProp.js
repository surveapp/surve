        ...
        <View>
            <LinearGradient colors={["#FFA439", "#FF5353"]} start={[0, 1]} end={[1, 0]} locations={[0.6, 2]}>
                ...
                <View style={styles.subContainer}>
                    <ScrollView>
                        <Service imageBre = {require("../../Images/flame.png")} price = "$20.99" color = "#FB8EE3" food = "Romantic Pack"/>
                        <Service imageBre = {require("../../Images/birthday.png")} price = "$6.99" color = "#F0DA14" food = "Birthday Pack"/>
                        <Service imageBre = {require("../../Images/holiday.png")} price = "$2.99" color = "#23B856" food = "Holiday Pack"/>
...
export default IndianServiceProp;
