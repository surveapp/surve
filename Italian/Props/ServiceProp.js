    ...
    return (
        <View>
            ...
            <View style={styles.subContainer}>
                <ScrollView>
                    <Service imageBre = {require("../../Images/flame.png")} price = "$15.99" color = "#FB8EE3" food = "Romantic Pack"/>
                    <Service imageBre = {require("../../Images/birthday.png")} price = "$3.99" color = "#F0DA14" food = "Birthday Pack"/>
                    <Service imageBre = {require("../../Images/holiday.png")} price = "$10.99" color = "#23B856" food = "Holiday Pack"/>
